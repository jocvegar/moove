        ...
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
          ...
          >
            ...
            <div class="flex-grow">
              ...
              <p class="text-gray-100">UI Designer</p>
            </div>
          </div>
        </div>
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        ...
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
          ...
          >
            ...
            <div class="flex-grow">
              ...
              <p class="text-gray-100">Founder</p>
            </div>
          </div>
        </div>
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
          ...
          >
            ...
            <div class="flex-grow">
              ...
              <p class="text-gray-100">DevOps</p>
            </div>
          </div>
        </div>
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
          ...
          >
            ...
            <div class="flex-grow">
              ...
              <p class="text-gray-100">Software Engineer</p>
            </div>
          </div>
        </div>
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
